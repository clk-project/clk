...
#+SUBTITLE: Using clk commands as parameters in other commands (Ethereum dev tool example)
...
* advanced use case: getting the abi path from a project
  ...
  #+RESULTS[02c56cb284626fd8e3f8c2dd2579ba88ad84d5f8]: run-with-project-abi
...
* Footnotes
  ...
  :ID:       8d9e97a5-dcf5-46ff-a584-7a38e680edb8
  :END:
...
#+NAME: test
#+BEGIN_SRC bash :results none :exports none :noweb yes :shebang "#!/usr/bin/env bash" :tangle ../../tests/use_cases/ethereum_local_environment_dev_tool.sh
    set -eu
    <<init>>
