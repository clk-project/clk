...
* outputting JSON data
  :PROPERTIES:
  :CUSTOM_ID: outputting-json-data
  :END:

When your command needs to output structured data, ~echo_json~ from ~clk.lib~
provides formatted and syntax-highlighted JSON output.

#+name: with_echo_json_code
#+BEGIN_SRC python :exports code
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
#+RESULTS[78f97b1fe6b7129e3969af62a23289830630feea]: use_echo_json
: {
:     "greeting": "Hello",
:     "items": [
:         "one",
...
The output is automatically colorized in terminals that support colors. When
piping to other commands or in dumb terminals, plain JSON is produced.
