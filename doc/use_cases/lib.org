...
When the server says how big the file is and you are looking at a terminal,
~download~ draws a progress bar as it goes. Here we hand it a terminal that
keeps what was drawn on it.
