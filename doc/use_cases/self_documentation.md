...
When you start using clk extensively, you might end up with many [aliases](controlling_my_music.md), [parameters](setting_default_values.md), [commands](checking_my_server.md), and [extensions](creating_extensions.md) spread across different profiles. The `clk describe` command helps you discover what features are available in any profile, making clk a self-documented tool.
