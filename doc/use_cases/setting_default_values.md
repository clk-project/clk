...
- [managing values: unset](#managing-values)
...
# managing values: unset

As your configuration evolves, some values stop being useful. Say you set one for an application you no longer work on:

```bash
clk value set myapp.color true
```

When you no longer need it, you can unset it:
