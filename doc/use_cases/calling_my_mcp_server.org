...
* keeping it in the project
  ...
  In the project of my MCP server, I keep the demo-buyer password in the
  password manager of my desktop session, behind the Secret Service interface,
  rather than in the team keyring.
