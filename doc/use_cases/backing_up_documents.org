...
* starting with a backup group
  :PROPERTIES:
  :CUSTOM_ID: 1dc62bf4-f072-4d41-8332-8e36c935986d
  :END:
...
* persisting the destination
  :PROPERTIES:
  :CUSTOM_ID: f1a96546-e591-481b-a425-bc7a39e56dd6
  :END:
...
* adding more backup targets
  :PROPERTIES:
  :CUSTOM_ID: 32c0cfd1-07ab-4f3c-854b-e6a1b13ccbe5
  :END:
...
* organizing with nested groups
  :PROPERTIES:
  :CUSTOM_ID: 14488552-499b-4212-be23-e07c7df5e68b
  :END:
...
* chaining backups with flows
  :PROPERTIES:
  :CUSTOM_ID: fe027a54-20dd-4d85-aa1f-7b6aa4d083c4
  :END:
...
* creating a full backup alias
  :PROPERTIES:
  :CUSTOM_ID: 50e4a5e1-c60f-448f-bf30-e0cc255fa96b
  :END:
...
* shortcut aliases for common scenarios
  :PROPERTIES:
  :CUSTOM_ID: acc52577-dff0-47ee-a0be-0b82beeffb82
  :END:
...
* per-project backup configuration
  :PROPERTIES:
  :CUSTOM_ID: 65537dcf-015c-4dbd-9479-faa5282f1864
  :END:
...
* personal preferences with a hostname extension
  :PROPERTIES:
  :CUSTOM_ID: 41dfc4f9-e04b-4e10-a6e7-0fa7bf0ffb26
  :END:
...
you explicitly disable it. Let's try it.
...
#+RESULTS[9330526704ca04fc08dac2f7b44e0e8f0545c0b4]: back-to-home
...
#+RESULTS[c2de72eb8e0154d3db842611d2ee221e7f6b3636]: try-disable-hostname
: Backing up documents from ~/docs to /mnt/my-nas/documents

Even after disabling, the hostname extension remains active and its parameters
are still applied. This is practical to put personal preferences that apply
everywhere, while still respecting project-specific overrides when they exist.
...
* seeing everything at a glance
  :PROPERTIES:
  :CUSTOM_ID: 1b9ca160-b8ea-4a5e-9455-01225e26c058
  :END:
...
* summary
  :PROPERTIES:
  :ID:       9d61364d-7246-4218-bcd8-b4b08d91ece3
  :CUSTOM_ID: 69f8a2f5-ba36-41fc-9d2c-6235b839bd9b
  :END:
...
#+BEGIN_SRC bash :exports none :tangle ../../tests/use_cases/backing_up_documents.sh :noweb yes :shebang "#!/usr/bin/env bash"
set -eu
<<init>>
