...
#+SUBTITLE: Sharing configuration between Python groups and bash subcommands via environment variables
...
#+NAME: create-ext
#+BEGIN_SRC bash :results none :exports none :session 1edede93-21b4-4109-a904-b746df3c2e8d :noweb yes
...
#+BEGIN_SRC bash :exports none :tangle ../../tests/use_cases/multi_environment_deployment_tool.sh :noweb yes :shebang "#!/usr/bin/env bash"
  set -eu
<<init>>
