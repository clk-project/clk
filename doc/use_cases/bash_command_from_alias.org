...
#+SUBTITLE: Wrapping CLI tools with aliases, then graduating to bash commands
...
#+BEGIN_SRC bash :exports none :tangle ../../tests/use_cases/bash_command_from_alias.sh :noweb yes :shebang "#!/usr/bin/env bash"
  set -eu
  <<init>>
