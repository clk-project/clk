...
#+SUBTITLE: Fetching JSON from APIs and displaying with syntax highlighting, download, echo_json
...
* Fetching and displaying JSON
  :PROPERTIES:
  :CUSTOM_ID: fetching-and-displaying-json
  :END:
...
* Caching the downloaded data
  :PROPERTIES:
  :CUSTOM_ID: caching-the-downloaded-data
  :END:
...
#+NAME: script
#+BEGIN_SRC bash :results none :exports none :tangle ../../tests/use_cases/fetching_and_displaying_json_data.sh :noweb yes :shebang "#!/usr/bin/env bash"
  set -eu
  <<init>>
