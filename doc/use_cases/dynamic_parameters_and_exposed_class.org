...
Then, you will most likely want to make the word ~http~ more explicit, either by [[file:chaotic_simulator_manager.org][rolling your own command]]
...
#+NAME: final
#+BEGIN_SRC bash :results none :exports none :tangle ../../tests/use_cases/dynamic_parameters_and_exposed_class.sh :noweb yes :shebang "#!/usr/bin/env bash"
  set -eu
<<init>>
