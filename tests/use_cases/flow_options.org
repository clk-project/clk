...
Then, in the print.py file that just opened, there is already the group printer
...
#+NAME: inject-doc
#+BEGIN_SRC bash :session 73f5d57e-d16a-490a-b4e1-0254d6296590 :results none :var documentation=documentation
...
#+NAME: script
#+BEGIN_SRC bash :tangle flow_options.sh :noweb yes :shebang "#!/bin/bash -eu" :var documentation=documentation
  <<init>>
