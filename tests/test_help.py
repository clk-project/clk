...
def test_main_help(lib):
    some_part_of_the_help_message = 'We truly believe that command line usage should be fast, intuitive'
...
def test_group_help(lib):
    some_part_of_the_help_message = 'append  Add a parameter after the parameters of a command'
