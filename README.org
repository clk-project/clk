...
[[./doc/use_cases/README.org][use cases]] classical situations where clk is worth being used. In the future, we
...
* Use cases
  ...
  the [[./doc/use_cases/README.org][use cases]] to find out how clk could be used in real life situations.

  #+INCLUDE: "./doc/use_cases/README.org::#what-do-you-want-to-do" :only-contents t
...
* In a nutshell
  ...
  #+BEGIN_SRC bash :tangle installer.sh :shebang "#!/usr/bin/env bash"
  ...
  Then wrap the tools you already use, like in [[./doc/use_cases/controlling_my_music.org][controlling my music]].

  #+INCLUDE: "./doc/use_cases/controlling_my_music.org::#wrapping-the-music-player" :only-contents t

  This actually does not tell you much why *clk* is so awesome. Try taking a look,
  the [[./doc/use_cases/README.org][use cases]] to get more real life examples.
* Rationale
  :PROPERTIES:
...
* Note on version
  ...
  *clk* is quite old, and most of its concepts are stable. There are still a few
  ...
  up describing all the [[./doc/use_cases/README.org][use cases]] that matter to me before considering it ready.
* Coverage reports
  :PROPERTIES:
  :CREATED:  [2026-02-20 12:38]
  :CUSTOM_ID: a53fa97d-ceb5-44e9-b921-89cf03d2775d
  :END:
  Coverage reports are automatically generated and committed by CI on each push to main.

  - [[./coverage-reports/testiq-report.md][TestIQ Report]] - Test duplicate/redundancy analysis
  - [[./coverage-reports/overlap.md][Overlap Report]] - Test coverage overlap analysis
  - [[./coverage-reports/line-heat.md][Line Heat Map]] - Lines covered by many tests
