...
|------|--------------|-------|
| alias:alias_conserves_parameters | parameter:parameter_to_alias | 2999 |
| parameter:simple_parameter | alias:alias_conserves_parameters | 2728 |
| alias:alias_conserves_parameters_of_group | alias:alias_conserves_parameters_of_group_with_exposed_class | 3186 |
| alias:alias_conserves_parameters_of_group | alias:alias_overrides_parameters | 3186 |
| alias:alias_conserves_parameters_of_group_with_exposed_class | alias:alias_overrides_parameters | 3195 |
...
| alias:composite_alias | alias:simple_alias_command | 2935 |
| alias:simple_alias_command | alias:composite_alias | 2935 |
...
| flow:overwrite_flow | flow:extend_flow | 3313 |
...
| use_cases:use_case[environment_deployment] | use_cases:use_case[3D_printing_flow] | 3292 |
...
| use_cases:use_case[environment_deployment] | use_cases:use_case[backing_up_documents] | 3292 |
...
| use_cases:use_case[environment_deployment] | use_cases:use_case[ethereum_local_environment_dev_tool] | 3292 |
| use_cases:use_case[environment_deployment] | use_cases:use_case[podcast_automation] | 3292 |
...
|--------|--------|-------|-------|---------|---------|
| alias:alias_conserves_parameters | parameter:replacing_parameters | 91.0% | 99.9% | 2999 | 2731 |
| alias:alias_conserves_parameters | use_cases:use_case[3D_printing_flow] | 99.9% | 74.0% | 2999 | 4046 |
| alias:alias_conserves_parameters | use_cases:use_case[using_a_project] | 99.9% | 85.1% | 2999 | 3523 |
| alias:alias_conserves_parameters_of_group | command:invoked_commands_still_work_even_though_they_are_no_customizable | 89.4% | 99.9% | 3186 | 2852 |
| alias:alias_conserves_parameters_of_group_with_exposed_class | command:invoked_commands_still_work_even_though_they_are_no_customizable | 89.2% | 99.9% | 3195 | 2852 |
| alias:alias_overrides_parameters | command:invoked_commands_still_work_even_though_they_are_no_customizable | 88.9% | 99.9% | 3203 | 2852 |
| alias:alias_to_clk | use_cases:use_case[alias_to_root] | 99.9% | 88.7% | 2967 | 3340 |
| alias:composite_alias | use_cases:use_case[global_workflow_local_implementation] | 99.9% | 79.6% | 2935 | 3684 |
| alias:composite_alias | use_cases:use_case[using_a_project] | 99.9% | 83.3% | 2935 | 3523 |
| alias:simple_alias_command | use_cases:use_case[global_workflow_local_implementation] | 99.9% | 79.6% | 2935 | 3684 |
| alias:simple_alias_command | use_cases:use_case[using_a_project] | 99.9% | 83.3% | 2935 | 3523 |
...
| custom:default_help_message_triggers_a_warning | use_cases:use_case[ethereum_local_environment_dev_tool] | 99.9% | 80.3% | 3196 | 3974 |
...
| parameter:parameter_to_alias | parameter:replacing_parameters | 90.8% | 99.9% | 3004 | 2731 |
...
| parameter:replacing_parameters | use_cases:use_case[using_a_project] | 99.9% | 77.4% | 2731 | 3523 |
| parameter:simple_parameter | run:can_edit_parameters | 99.9% | 91.4% | 2728 | 2981 |
| parameter:simple_parameter | use_cases:use_case[3D_printing_flow] | 99.9% | 67.3% | 2728 | 4046 |
| parameter:simple_parameter | use_cases:use_case[using_a_project] | 99.9% | 77.4% | 2728 | 3523 |
| use_cases:use_case[bash_command_built_in_lib] | use_cases:use_case[bash_command_from_alias] | 99.9% | 71.5% | 2974 | 4155 |
| use_cases:use_case[bash_command_from_alias] | use_cases:use_case[bash_command_import] | 77.6% | 99.9% | 4155 | 3228 |
...
| Test | Lines Covered |
|------|---------------|
| use_cases:use_case[backing_up_documents] | 4556 |
| use_cases:use_case[bash_command_from_alias] | 4155 |
| use_cases:use_case[self_documentation] | 4143 |
| use_cases:use_case[3D_printing_flow] | 4046 |
| use_cases:use_case[ethereum_local_environment_dev_tool] | 3974 |
| use_cases:use_case[creating_extensions] | 3970 |
| use_cases:use_case[setting_default_values] | 3812 |
| command:command | 3723 |
| use_cases:use_case[wrapping_a_cloud_provider_cli] | 3712 |
| use_cases:use_case[global_workflow_local_implementation] | 3684 |
| custom:capture_alias | 3573 |
| help:main_help | 3549 |
| use_cases:use_case[dynamic_parameters_and_exposed_class] | 3537 |
| use_cases:use_case[using_a_project] | 3523 |
...
| use_cases:use_case[podcast_automation] | 3440 |
| use_cases:use_case[using_a_plugin] | 3428 |
| ... | *87 more tests* |
